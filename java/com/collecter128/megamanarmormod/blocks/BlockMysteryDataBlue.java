...
public class BlockMysteryDataBlue extends HalfTransparentBlock{
	
	
	   public BlockMysteryDataBlue(BlockBehaviour.Properties properties) {
		super(properties);
	   }
	...
	/**
	   ...
	   //public void onRemove(World worldIn, BlockPos pos, BlockState state, PlayerEntity player) {
	      if (!worldIn.isClientSide) {
	    	 ...
	    	 switch(RandomInt) {
	    		 case 0: 
	    		 	itemstackIn = new ItemStack(ItemInit.DataBuster.get());
	    		 	break;
//	    	 		case 1: 
