...
public class BlockMysteryWavePurple extends HalfTransparentBlock{
	
	
	   public BlockMysteryWavePurple(BlockBehaviour.Properties properties) {
		super(properties);
	   }
	...
	/**
	   ...
	   //public void onRemove(World worldIn, BlockPos pos, BlockState state, PlayerEntity player) {
	      if (!worldIn.isClientSide) {
	    	 ...
	    	 switch(RandomInt) {
	    		 case 0: 
	    		 	itemstackIn = new ItemStack(ItemInit.WaveAM.get(), 2);
	    		 	break;
//	    	 		case 1: 
