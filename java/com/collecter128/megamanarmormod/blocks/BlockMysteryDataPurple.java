...
public class BlockMysteryDataPurple extends HalfTransparentBlock{
	
	
	   public BlockMysteryDataPurple(BlockBehaviour.Properties properties) {
		super(properties);
	   }
	...
	/**
	   ...
	   //public void onRemove(World worldIn, BlockPos pos, BlockState state, PlayerEntity player) {
	      if (!worldIn.isClientSide) {
	    	 ItemStack itemstackIn = new ItemStack(ItemInit.DataBuster.get());
	    	 ...
	    	 switch(RandomInt) {
	    		 case 0: 
	    		 	itemstackIn = new ItemStack(ItemInit.DataBuster.get(), 2);
	    		 	break;
//	    	 		case 1: 
