...
public class MegamanArmorModel extends GeoModel<MegamanArmorItem>{
	 @Override
	    public ResourceLocation getModelResource(MegamanArmorItem animatable) {
...
//			 return new ResourceLocation(MegamanArmorMod.MODID, "geo/megaman_helmet.geo.json");
	    ...
	    @Override
	    public ResourceLocation getTextureResource(MegamanArmorItem animatable) {
...
//	    		return new ResourceLocation(MegamanArmorMod.MODID, "textures/armor/megaman_armor.png");
	    ...
	    @Override
	    public ResourceLocation getAnimationResource(MegamanArmorItem animatable) {
